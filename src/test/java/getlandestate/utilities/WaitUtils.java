...
public class WaitUtils {
    ...
    public static void waitForPageToLoad(long timeout) {
        ...
        try {
            ...
            WebDriverWait wait = new WebDriverWait(getlandestate.utilities.Driver.getDriver(), Duration.ofSeconds(timeout));
    ...
    public static WebElement fluentWait(String xpath, int withTimeout, int pollingEvery) {
        FluentWait<WebDriver> wait = new FluentWait<WebDriver>(getlandestate.utilities.Driver.getDriver())
