...
public class ReusableMethods {
    ...
    public static void alertAccept() {
        getlandestate.utilities.Driver.getDriver().switchTo().alert().accept();
    }

    // Alert DISMISS
    public static void alertDismiss() {
        getlandestate.utilities.Driver.getDriver().switchTo().alert().dismiss();
    }

    // Alert getText()
    public static String alertText() {
        return getlandestate.utilities.Driver.getDriver().switchTo().alert().getText();
    }

    // Alert promptBox
    public static void alertPrompt(String text) {
        getlandestate.utilities.Driver.getDriver().switchTo().alert().sendKeys(text);
    }
    ...
    */
    ...
    public static void switchToWindow(int index) {
        List<String> allWindowHandles = new ArrayList<>(getlandestate.utilities.Driver.getDriver().getWindowHandles());
        getlandestate.utilities.Driver.getDriver().switchTo().window(allWindowHandles.get(index));
    }

    // Switch to Window by Object
    public static void window(int index) {
        getlandestate.utilities.Driver.getDriver().switchTo().window(getlandestate.utilities.Driver.getDriver().getWindowHandles().toArray()[index].toString());
    }

    // EXPLICIT WAIT METHODS
    // Visible Wait
    public static void visibleWait(WebElement element, int seconds) {
        WebDriverWait wait = new WebDriverWait(getlandestate.utilities.Driver.getDriver(), Duration.ofSeconds(seconds));
    ...
    public static void screenShot(String name) {
        ...
        TakesScreenshot ts = (TakesScreenshot) getlandestate.utilities.Driver.getDriver();
    ...
    public static void printData(int row, int column) {
        WebElement rowColumn = getlandestate.utilities.Driver.getDriver().findElement(By.xpath("(//tbody)[1]//tr[" + row + "]//td[" + column + "]"));
